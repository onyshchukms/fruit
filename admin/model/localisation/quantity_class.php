...
class ModelLocalisationQuantityClass extends Model {
	public function addQuantityClass($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "quantity_class SET value = '" . (float)$data['value'] . "'");
	...
	public function editQuantityClass($quantity_class_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "quantity_class SET value = '" . (float)$data['value'] . "' WHERE quantity_class_id = '" . (int)$quantity_class_id . "'");
