...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_quantity_class'] = $this->language->get('text_quantity_class');
		...
		$data['quantity_class'] = $this->url->link('localisation/quantity_class', 'token=' . $this->session->data['token'], 'SSL');
